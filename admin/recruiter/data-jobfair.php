        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title ">Data Peserta Jobfair</h3>
                <div class="tombol-kanan">
                  <a href="export-jobfair.php" class="btn btn-default btn-sm">&nbsp;<i class="fa fa-lg  fa-download"></i>&nbsp; Export to Excel&nbsp;</a>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                $query = "SELECT * FROM user_daftar ORDER BY id DESC";
                ...
                <tr>
                 ...
                 <!--  <td><?php echo $row['alamat']; ?></td> -->
                  ...
                  <a href="lihat-jobfair.php?id=<?php echo $row['id']; ?>" class="btn btn-primary btn-sm">&nbsp;<i class="fa fa-lg fa-eye"></i> Lihat</a>
                  <a href="hapus-jobfair.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini ?')" 
