                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    ...
                    <div class="box-footer">
                      <a href="?pages=pelamar" type="button" name="kembali" class="btn btn-default"><i class="fa  fa-refresh"></i> &nbsp;Kembali</a>
        ...
        if (isset($_POST['submit'])) {
	     ...
	     // Proses simpan data ke Database
          ...
          if($sql){ // Cek jika proses simpan ke database sukses atau tidak
            // Jika Sukses, Lakukan :
            echo "<script language='javascript'>window.alert('Update Complete, Data berhasil di Update.'), window.location = 'index.php?pages=pelamar';</script>"; // Redirect ke halaman index.php
          }else{
            // Jika Gagal, Lakukan :
