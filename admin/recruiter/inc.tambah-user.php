       ...
       <?php
        ...
        if (isset($_POST['submit'])) {
	      ...
	      if($sql){ // Cek jika proses simpan ke database sukses atau tidak
	        // Jika Sukses, Lakukan :
	        echo "<script language='javascript'>window.alert('Proses Complete, Data berhasil di simpan.'), window.location = 'index.php?pages=pelamar';</script>";
	      }else{
	        // Jika Gagal, Lakukan :
	        // echo "<script language='javascript'>window.alert('Maaf, Terjadi kesalahan saat mencoba untuk menyimpan data ke database.'), window.location = 'index.php?pages=pelamar';</script>";

          // echo '<script language="javascript">swal("Sorry!", "Failed to add users!", "error"), 
          // window.location = "index.php?pages=pelamar";</script>';

           echo "<script language='javascript'window.location = 'index.php?pages=pelamar&message=error2';</script>";
	      }
