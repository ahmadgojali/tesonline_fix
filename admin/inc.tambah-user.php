       ...
       <?php
        ...
        if (isset($_POST['submit'])) {
	      ...
	      if($sql){ // Cek jika proses simpan ke database sukses atau tidak
	        // Jika Sukses, Lakukan :
	        echo "<script language='javascript'>window.alert('Proses Complete, Data berhasil di simpan.'), window.location = 'index.php?pages=pelamar';</script>"; // Redirect ke halaman index.php
	      }else{
	        // Jika Gagal, Lakukan :
