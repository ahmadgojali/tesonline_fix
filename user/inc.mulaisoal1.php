    ...
    if (isset($_POST['latihan'])) {
      ...
      if ($jawaban == $jwb_benar) {
        $alert = '<div class="alert alert-success" role="alert">
         ...
         $tombol = '<a href="?pages=soal-mtk-dasar" class="btn btn-success">Mulai</a>';
                ...
                <div class="col-md-12">
                  ...
                  <tr>
                    <div class="form-group pl-md-5 pr-3">
                      <input type="text" name="jawaban" value="" class="form-control"  placeholder="Jawab disini" autocomplete="off" onkeypress='validate(event)'>
                    </div>
                  </tr>
                </div>
              </div>
